    ...
    public void start(Stage primaryStage) {
        ...
        loginButton.setOnAction(event -> {
            ...
            if (user!= null) {
                ...
                // String stocks = user.getString("Stocks");

                // Pass the user data to MainPageTest.java
                // MainPageTest mainPageTest = new MainPageTest(userId, companyId, stocks);
                // mainPageTest.start(primaryStage); // Start the main page test
